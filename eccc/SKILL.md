---
name: eccc
description: Extraordinary Chambers in the Courts of Cambodia (ECCC) research, drafting, and analysis. Use whenever the conversation involves the ECCC, the Khmer Rouge Tribunal, Case 001 (Duch), Case 002 (Nuon Chea, Khieu Samphan, Ieng Sary, Ieng Thirith) including the severance into Case 002/01 and Case 002/02, Case 003 (Meas Muth), Case 004 (Im Chaem, Ao An, Yim Tith), the ECCC Law, the ECCC Internal Rules, the UN-Cambodia Agreement, ECCC procedure (Pre-Trial Chamber, Trial Chamber, Supreme Court Chamber, Office of the Co-Investigating Judges, Office of the Co-Prosecutors), civil party participation, reparations at the ECCC, joint criminal enterprise (JCE) as applied at the ECCC, crimes within ECCC jurisdiction (genocide, crimes against humanity, grave breaches of the 1949 Geneva Conventions, 1956 Cambodian Penal Code offences), closing orders, indictments, judgments, appeals, or citation of any ECCC document. Enforces a verification-first discipline: every case-law, decision, order, filing, or judgment citation must be verified against eccc.gov.kh or legal-tools.org before appearing in any output. Foundational texts (ECCC Law as amended, UN-Cambodia Agreement, Internal Rules) may be cited from project knowledge when present. Trigger this skill any time ECCC, Extraordinary Chambers, Khmer Rouge Tribunal, KRT, or ECCC case identifiers (e.g. Case 002/19-09-2007/ECCC/...) appear in the request, even if the user does not explicitly ask for ECCC research.
---
