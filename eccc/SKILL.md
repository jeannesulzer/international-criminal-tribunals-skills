---
name: eccc
description: Extraordinary Chambers in the Courts of Cambodia (ECCC, Khmer Rouge Tribunal) research, drafting, and analysis. Use whenever the conversation involves the ECCC, Case 001 (Duch), Case 002 (NUON Chea, KHIEU Samphan) including the severance into Cases 002/01 and 002/02, Cases 003 and 004, the ECCC Law, the Internal Rules, the UN-Cambodia Agreement, the chambers and co-organs, civil party participation and reparations, JCE as applied at the ECCC, or any ECCC document or case identifier (e.g. Case 002/19-09-2007/ECCC/...). Enforces a verification-first discipline: every case-law, decision, order, filing, or judgment citation must be verified against eccc.gov.kh or legal-tools.org before appearing in any output. Foundational texts (ECCC Law as amended, UN-Cambodia Agreement, Internal Rules) may be cited from project knowledge when present. Trigger any time ECCC, Extraordinary Chambers, Khmer Rouge Tribunal, or KRT appears, even if the user does not explicitly ask for ECCC research.
---
