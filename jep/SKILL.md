---
name: jep
description: Jurisdicción Especial para la Paz (JEP) — Colombia's Special Jurisdiction for Peace — research, drafting, and analysis. Use whenever the conversation involves the JEP, the SIVJRNR / Sistema Integral para la Paz, the 2016 Final Peace Agreement with the FARC-EP, Acto Legislativo 01 de 2017, Ley Estatutaria 1957 de 2019, the 11 macrocasos (Caso 01 secuestro, Caso 03 falsos positivos, Caso 07 reclutamiento de menores, Caso 11 violencia sexual...), the Salas and the Tribunal Especial para la Paz, sanciones propias and TOAR, the régimen de condicionalidad, or the first restorative sentences of September 2025. Enforces a verification-first discipline: every resolución, sentencia, auto, or providencia citation must be verified against jep.gov.co before appearing in any output. Foundational texts (Acuerdo Final 2016, Acto Legislativo 01/2017, Ley 1957/2019, Reglamento General) may be cited from project knowledge when present. Trigger on JEP, Sistema Integral, sanciones propias, falsos positivos, or Casos 01-11.
---
