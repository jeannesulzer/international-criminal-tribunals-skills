---
name: jep
description: Jurisdicción Especial para la Paz (JEP) — Colombia / Special Jurisdiction for Peace research, drafting, and analysis. Use whenever the conversation involves the JEP, the Sistema Integral de Verdad, Justicia, Reparación y No Repetición (SIVJRNR) / Sistema Integral para la Paz, the 24 November 2016 Final Peace Agreement (Acuerdo Final) between the Colombian Government and the FARC-EP, the Acto Legislativo 01 of 2017, Ley Estatutaria 1957 of 2019 (the Estatutaria de la JEP), the 11 macrocasos (Caso 01 secuestro / kidnapping by FARC-EP, Caso 02 Nariño territorial, Caso 03 falsos positivos / asesinatos y desapariciones forzadas ilegítimamente presentadas como bajas en combate por agentes del Estado, Caso 04 Urabá territorial, Caso 05 Norte del Cauca y sur del Valle del Cauca territorial, Caso 06 victimización Unión Patriótica, Caso 07 reclutamiento de niñas y niños, Caso 08 crímenes Fuerza Pública en asocio con paramilitares, Caso 09 crímenes contra pueblos étnicos, Caso 10 crímenes FARC-EP, Caso 11 violencia sexual), the Sala de Reconocimiento de Verdad / Sala de Definición de Situaciones Jurídicas / Sala de Amnistía o Indulto / Tribunal Especial para la Paz / Sección de Reconocimiento de Verdad / Sección de Ausencia de Reconocimiento, the principles of sanciones propias / alternativas / ordinarias, the Trabajos, Obras y Actividades con contenido Reparador y Restaurador (TOAR), the Comisión para el Esclarecimiento de la Verdad, la Convivencia y la No Repetición (CEV), the Unidad de Búsqueda de Personas dadas por Desaparecidas (UBPD), the régimen de condicionalidad, the comparecientes (FARC-EP, Fuerza Pública, terceros civiles), the first sentences of September 2025, or any JEP document or case identifier. Enforces a verification-first discipline: every case-law, decision, resolución, sentencia, auto, or providencia citation must be verified against jep.gov.co (the official JEP website) before appearing in any output. Foundational texts (Acuerdo Final 2016, Acto Legislativo 01 of 2017, Ley Estatutaria 1957 of 2019, Reglamento General de la JEP) may be cited from project knowledge when present. Trigger this skill any time JEP, Jurisdicción Especial para la Paz, Special Jurisdiction for Peace, Sistema Integral, sanciones propias, falsos positivos, Caso 01-11, FARC-EP, Acuerdo de Paz Colombia, or any related identifier appears in the request.
---
