---
name: cps-rca
description: Cour Pénale Spéciale de la République Centrafricaine (CPS) / Special Criminal Court in the Central African Republic (SCC-CAR) research, drafting, and analysis. Use whenever the conversation involves the CPS, the Loi organique n°15.003 of 3 June 2015, the RPP (Loi 18.010), the affaire Paoua / Lemouna et Koundjili (Issa Sallet Adoum et al.), the Ndélé cases, complementarity with the ICC's CAR situations, MINUSCA cooperation, the hybrid national-international composition, or any CPS document or case identifier. Enforces a verification-first discipline: every citation must be verified against cpsrca.cf or, when it is unreachable, the documented fallbacks (legal-tools.org, JusticeInfo, FIDH, HRW) before appearing in any output. Foundational texts (Loi organique 15.003, Loi 18.010, Code pénal centrafricain) may be cited from project knowledge when present. Trigger any time CPS, Cour pénale spéciale, SCC-CAR, Paoua, Lemouna, Koundjili, Ndélé, or 3R appears in the request.
---
