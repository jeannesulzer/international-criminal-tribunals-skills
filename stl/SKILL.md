---
name: stl
description: Special Tribunal for Lebanon (STL / TSL) research, drafting, and analysis. Use whenever the conversation involves the STL, the assassination of Rafiq Hariri (14 February 2005), the Ayyash et al. case (STL-11-01), Merhi, the related-attacks case (STL-18-10), the contempt cases (STL-14-05 New TV/Al-Khayat; STL-14-06 Akhbar Beirut/Al-Amin), UNSC Resolution 1757 (2007), the application of Lebanese criminal law, trial in absentia, the February 2011 Interlocutory Decision on terrorism, victim participation, or the closure of the STL in December 2023. Enforces a verification-first discipline: every case-law, decision, indictment, filing, or judgment citation must be verified against the STL legacy archive or legal-tools.org before appearing in any output. Foundational texts (UN-Lebanon Agreement, Statute, Rules of Procedure and Evidence) may be cited from project knowledge when present. Trigger any time STL, TSL, Hariri tribunal, Ayyash, or Resolution 1757 appears.
---
