...
description: International Criminal Tribunal for the former Yugoslavia (ICTY), International Criminal Tribunal for Rwanda (ICTR), and International Residual Mechanism for Criminal Tribunals (IRMCT / MICT) research, drafting, and analysis. Use whenever the conversation touches the ad hoc UN tribunals or their residual mechanism — case law, judgments, decisions, indictments, filings — including landmark holdings on genocide, crimes against humanity, war crimes, joint criminal enterprise, command responsibility, and sexual violence. Enforces a verification-first citation discipline: no case citation appears in an output until verified against irmct.org, the Case Law Database, the Unified Court Records, the legacy sites, or legal-tools.org. Triggers on ICTY, ICTR, IRMCT, MICT, the Mechanism, Tadić, Akayesu, Krstić, Kunarac, Furundžija, Blaškić, Kambanda, Karadžić, Mladić, Kabuga, Srebrenica genocide, Rwanda genocide, Arusha, The Hague tribunals.
---
