...
description: International Criminal Tribunal for the former Yugoslavia (ICTY), International Criminal Tribunal for Rwanda (ICTR), and the International Residual Mechanism for Criminal Tribunals (IRMCT / MICT / "the Mechanism") research, drafting, and analysis. Use whenever the conversation touches the ad hoc UN tribunals or their residual mechanism — case law, judgments, decisions, indictments, filings, OTP submissions — including landmark holdings on genocide, crimes against humanity, war crimes, joint criminal enterprise, command responsibility, and sexual violence as an international crime. Enforces a verification-first citation discipline: no case citation appears in an output until it has been verified against irmct.org, the Unified Court Records (UCR) database, the ICTY/ICTR legacy sites, or legal-tools.org. Triggers on ICTY, ICTR, IRMCT, MICT, the Mechanism, Tadić, Akayesu, Krstić, Kunarac, Furundžija, Blaškić, Galić, Kambanda, Karadžić, Mladić, Šešelj, Kabuga, Srebrenica genocide, Rwanda genocide, Arusha, The Hague tribunals.
---
