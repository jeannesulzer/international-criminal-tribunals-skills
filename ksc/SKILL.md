---
name: ksc
description: Kosovo Specialist Chambers (KSC) and Specialist Prosecutor's Office (SPO) research, drafting, and analysis. Use whenever the conversation involves the KSC/KRSJI, the Thaçi et al. case (KSC-BC-2020-06; Thaçi, Veseli, Selimi, Krasniqi), Mustafa (KSC-BC-2020-05), Shala (KSC-BC-2020-04), Gucati and Haradinaj (KSC-BC-2020-07), Law No. 05/L-053, Article 162 of the Kosovo Constitution, the Marty Report (2011), KLA-related crimes 1998-2000, victim participation, the chamber structure, or any KSC document or case identifier. Enforces a verification-first discipline: every case-law, decision, indictment, filing, or judgment citation must be verified against scp-ks.org or legal-tools.org before appearing in any output; appeal registry numbers are cited only once confirmed. Foundational texts (Law No. 05/L-053, Article 162, Rules of Procedure and Evidence) may be cited from project knowledge when present. Trigger on KSC, Kosovo Specialist Chambers, SPO, Thaçi, Veseli, Selimi, Krasniqi, or a KSC case identifier.
---
