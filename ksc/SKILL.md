---
name: ksc
description: Kosovo Specialist Chambers (KSC) and Specialist Prosecutor's Office (SPO) research, drafting, and analysis. Use whenever the conversation involves the KSC, the Specialist Chambers, the Kosovo Relocated Specialist Judicial Institution (KRSJI), the SPO, the Thaçi et al. case (KSC-BC-2020-06) involving Hashim Thaçi, Kadri Veseli, Rexhep Selimi and Jakup Krasniqi, the Mustafa case (KSC-BC-2020-05), the Shala case (KSC-BC-2020-04), the Gucati and Haradinaj contempt case (KSC-BC-2020-07), the Januzi-Bahtijari-Haxhi Shala case (KSC-BC-2023-10), the Thaçi et al. administration of justice case (KSC-BC-2024-11), the Law on Specialist Chambers and Specialist Prosecutor's Office (Law No. 05/L-053), Article 162 of the Kosovo Constitution, the Council of Europe Parliamentary Assembly Report ("Marty Report") of 7 January 2011, allegations of crimes by Kosovo Liberation Army (KLA) members during and after the conflict in Kosovo between 1 January 1998 and 31 December 2000, victim participation under Rule 113 of the KSC Rules, the institutional structure (Basic Court Chamber, Court of Appeals Chamber, Supreme Court Chamber, Constitutional Court Chamber), or any KSC document or case identifier. Enforces a verification-first discipline: every case-law, decision, indictment, filing, or judgment citation must be verified against scp-ks.org (the official KSC website) or legal-tools.org before appearing in any output. Foundational texts (Law No. 05/L-053, Article 162 of the Constitution, Rules of Procedure and Evidence) may be cited from project knowledge when present. Trigger this skill any time KSC, Kosovo Specialist Chambers, KSPO, Specialist Prosecutor, Thaçi tribunal, Veseli, Selimi, Krasniqi, KLA war crimes prosecution, or any KSC case identifier appears in the request.
---
